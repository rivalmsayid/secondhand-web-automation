...
public class logout {
	@Given("user click button profile in header")
	public void user_click_button_profile_in_header() {
		WebUI.click(findTestObject('Object Repository/logout/button_profile'))
		WebUI.delay(3)
	}

	@When("user click keluar")
	public void user_click_keluar() {
		WebUI.click(findTestObject('Object Repository/logout/button_keluar'))
	}
